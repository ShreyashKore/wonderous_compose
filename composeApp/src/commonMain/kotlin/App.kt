...
import localization.rememberLocaleState
...
@Composable
fun App() {
    val localeState = rememberLocaleState()

    CompositionLocalProvider(LocalLocaleState provides localeState) {
        MaterialTheme(
                    ...
                    composable(
                        ...
                        HomeScreen(
                            ...
                            onChangeLanguage = { languageTag ->
                                localeState.setLanguage(languageTag)
                            }
                        )
